...
# Fix 1: Move remainingBs down below activeRates
remaining_bs_code = """
...
"""
content = content.replace(remaining_bs_code, '')
content = content.replace('const isHistoricalMode = !!historicalDate && !!historicalRates;', 'const isHistoricalMode = !!historicalDate && !!historicalRates;\n' + remaining_bs_code)

# Fix 2: Inject CustomNumpad and MixedPaymentModal
numpad_code = """
// ─── CUSTOM NUMPAD ─────────────────────────────────────────────
