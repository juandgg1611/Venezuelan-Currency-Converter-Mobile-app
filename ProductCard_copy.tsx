    ...
    <>
      ...
      >
        ...
        <View className="p-4">
          ...
          {/* Precios */}
          <View className="mb-3">
            <Text className="text-neutral-500 dark:text-neutral-400 text-[13px] font-medium line-through mb-0.5">
              Ref. {formatUSD(precioBase)}
            </Text>
            <View className="flex-row items-center justify-between gap-1">
              <Text
                className="text-primary-600 dark:text-primary-400 font-bold text-[20px] flex-shrink"
                adjustsFontSizeToFit
                numberOfLines={1}
              >
                {formatUSD(precioDivisas)}
              </Text>
              <View className="bg-primary-100 dark:bg-primary-900/40 px-2 py-0.5 rounded-md flex-shrink-0 ml-auto">
                <Text className="text-primary-600 dark:text-primary-400 font-bold text-[10px] tracking-wider">
                  15% OFF
                </Text>
              </View>
            </View>
          ...
          <ScrollView showsVerticalScrollIndicator={false} bounces={false}>
            ...
            <View className="px-6 pt-5 pb-12">
              ...
              <View className="flex-row items-center justify-between mb-1">
                ...
                <TouchableOpacity onPress={() => setQrModalVisible(true)} className="w-10 h-10 rounded-full bg-emerald-50 dark:bg-emerald-900/20 items-center justify-center">
