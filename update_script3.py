...
# Add CustomNumpad and MixedPaymentModal render
if "<CustomNumpad" not in content:
    # Append CustomNumpad below </View> of pillsRow / amountRow
    # But where exactly? Right below amountRow
    # I'll just append it right after the closing View of amountRow
