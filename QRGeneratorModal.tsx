  ...
  return (
    <Modal visible={visible} transparent animationType='fade' onRequestClose={onClose}>
      <View style={{ flex: 1, backgroundColor: 'rgba(0,0,0,0.6)', justifyContent: 'center', alignItems: 'center', padding: 24 }}>
        <View className='bg-white dark:bg-neutral-900 rounded-3xl w-full p-6 items-center'>
          ...
          <ViewShot ref={viewShotRef} options={{ format: 'png', quality: 1.0 }} style={{ backgroundColor: 'white', padding: 24, borderRadius: 24, alignItems: 'center' }}>
            ...
            <Text style={{ marginTop: 16, fontSize: 14, fontWeight: 'bold', color: 'black' }}>{product.name}</Text>
          </ViewShot>
